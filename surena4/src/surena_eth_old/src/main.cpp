...
#include <qdebug.h>
#include <QTimer>
#include "surena_eth_old/active_csp.h"
#include "surena_eth_old/reset_node.h"
#include "surena_eth_old/home.h"
...
//====================================================================================
 ...
 bool ActiveCSP(surena_eth_old::active_csp::Request  &req,surena_eth_old::active_csp::Response &res)
{
...
/// \return
/// ==========================================================================================
bool Home(surena_eth_old::home::Request  &req,surena_eth_old::home::Response &res)
{
    ROS_INFO("request: ipm init");
}
...
//   app.connect(&w, SIGNAL(, &app, SLOT(quit()));
   ...
   //ros::init(argc, argv, "surena_eth_old");
