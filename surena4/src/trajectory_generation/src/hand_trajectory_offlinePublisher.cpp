...
int main(int argc, char **argv)
{
  ...
  // address += "/home/milad/humanoid/surena4/src/trajectory_generation/src/OfflineWalkData/JointData";
     //address +="/home/cast/humanoid/surena4/src/trajectory_generation/src/HandOfflineData/hands_joint_data_b.txt";
address +="Desktop/hands_joint_data_grip.txt";
...
//qDebug()<<time;
        ...
        for (int i = 0; i <=3 ; ++i) {
          q_motor_r[i]= positionmat[count](0,i)+qra_offset[i];
          q_motor_l[i]= positionmat[count](0,i+8)+qla_offset[i];
                  }
        for (int i = 4; i <8 ; ++i) {
          q_motor_r[i]= positionmat[count](0,i);
          q_motor_l[i]= positionmat[count](0,i+8);
                  }
