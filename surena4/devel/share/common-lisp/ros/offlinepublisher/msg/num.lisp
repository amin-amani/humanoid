...
(cl:in-package offlinepublisher-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name offlinepublisher-msg:<num> is deprecated: use offlinepublisher-msg:num instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offlinepublisher-msg:first_name-val is deprecated.  Use offlinepublisher-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offlinepublisher-msg:last_name-val is deprecated.  Use offlinepublisher-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offlinepublisher-msg:age-val is deprecated.  Use offlinepublisher-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offlinepublisher-msg:score-val is deprecated.  Use offlinepublisher-msg:score instead.")
  (score m))
